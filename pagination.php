...
$sql = mysql_query("SELECT id, firstname, lastname FROM players ORDER BY id ASC");
...
$sql2 = mysql_query("SELECT id, firstname, lastname FROM players ORDER BY id ASC $limit"); 
...
<body style="background-color:#CCCCCC;">
   <div style="margin-left:64px; margin-right:64px;">
     <h2>Total Items: <?php echo $nr; ?></h2>
      ...
      <div style="margin-left:58px; margin-right:58px; padding:6px; background-color:#FFF; border:#999 1px solid; width:690px;"><?php echo $paginationDisplay; ?></div>
