...
<form method="post" name="f" enctype="multipart/form-data" onsubmit="return check();" action="http://www.cs.tut.fi/cgi-bin/run/~jkorpela/echo.cgi">
<p>
...
<textarea name="expl" rows="3" cols="40" onfocus="check();"></textarea>
<p>
